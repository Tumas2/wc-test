    ...
    <router-container>
        ...
        <main>
            <router-switch>
                ...
                <router-route path="/about" src="./pages/about-page.html"></router-route>
                <router-route path="/users/*" src="./pages/users-page.html" no-cache>
                    <?php
